    ...
    if choice in ["><<", "=><=<=", "=> <= =>"]:
        ...
        if input("No, no, it can't be..... It can't be gun!") == "krn8t6":
            ...
            if fun == "1":
                ...
                if fun == "gun":
                    print("Ah, you've outsmarted me. That deserves a tie! *spins around, showing he played gun too.*")
                    time.sleep(0.5)
            ...
            if fun == "2":
                ...
                if fun in ["scissors", "cissurs", "Scissors", "Cissurs", "S", "s", "C", "c"]:
                    ...
                    print("I played cissurs... ")
                    time.sleep(1)
                    print("I lose...")
                    time.sleep(2)
                    print("*he walks away, defeated*")
                    print("Ending 3! Also, happy mother's day!")
                elif fun in ["paper", "Paper", "peiber", "Peiber", "P", "p"]:
                    print("I played rocch... ")
                    time.sleep(1)
                    print("I lose...")
                    time.sleep(2)
                    print("*he walks away, defeated*")
                    print("Ending 3! Also, happy mother's day!")
                elif fun in ["gun", "Gun", "G", "g"]:
